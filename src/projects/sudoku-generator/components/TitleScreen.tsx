			...
			<div className="text-center p-6 sm:p-8 max-w-4xl mx-auto">
				<div className="bg-muted/20 rounded-lg p-8 mb-10">
					...
					<p className="text-muted-foreground mb-8 leading-relaxed text-lg sm:text-xl max-w-3xl mx-auto">
						Interactive Sudoku puzzle generator with manual solving featuring 
						pencil marks, hints, and AI solving algorithms (logical elimination 
						and backtracking). Challenge yourself or watch the algorithms work.
					</p>
